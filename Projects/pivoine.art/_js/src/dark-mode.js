...
(async () => {
  ...
  if (darkMode) {
    ...
    navbarEl?.insertBefore(darkMode, navbarEl.querySelector('.nav-insert-marker'));
    ...
    navbarBtn?.addEventListener('click', (e) => {
      ...
      if (
        ...
        navbarBtn.dispatchEvent(new CustomEvent('pivoine-dark-mode-toggle', { detail: false, bubbles: true }));
      } else {
        ...
        navbarBtn.dispatchEvent(new CustomEvent('pivoine-dark-mode-toggle', { detail: true, bubbles: true }));
      }
    });
