...
\restrict 6e7uZ9W0sqETd8UfXp7ddsASlAKcWRlNbmw5rbuDfC1aEQeo3tlsVQsvYmuatDn
...
--
-- Name: asbinary(public.geometry); Type: FUNCTION; Schema: public; Owner: valknar
--
...
ALTER FUNCTION public.asbinary(public.geometry) OWNER TO valknar;

--
-- Name: asbinary(public.geometry, text); Type: FUNCTION; Schema: public; Owner: valknar
--
...
ALTER FUNCTION public.asbinary(public.geometry, text) OWNER TO valknar;

--
-- Name: astext(public.geometry); Type: FUNCTION; Schema: public; Owner: valknar
--
...
ALTER FUNCTION public.astext(public.geometry) OWNER TO valknar;

--
-- Name: estimated_extent(text, text); Type: FUNCTION; Schema: public; Owner: valknar
--
...
ALTER FUNCTION public.estimated_extent(text, text) OWNER TO valknar;

--
-- Name: estimated_extent(text, text, text); Type: FUNCTION; Schema: public; Owner: valknar
--
...
ALTER FUNCTION public.estimated_extent(text, text, text) OWNER TO valknar;

--
-- Name: geomfromtext(text); Type: FUNCTION; Schema: public; Owner: valknar
--
...
ALTER FUNCTION public.geomfromtext(text) OWNER TO valknar;

--
-- Name: geomfromtext(text, integer); Type: FUNCTION; Schema: public; Owner: valknar
--
...
ALTER FUNCTION public.geomfromtext(text, integer) OWNER TO valknar;

--
-- Name: ndims(public.geometry); Type: FUNCTION; Schema: public; Owner: valknar
--
...
ALTER FUNCTION public.ndims(public.geometry) OWNER TO valknar;

--
-- Name: setsrid(public.geometry, integer); Type: FUNCTION; Schema: public; Owner: valknar
--
...
ALTER FUNCTION public.setsrid(public.geometry, integer) OWNER TO valknar;

--
-- Name: srid(public.geometry); Type: FUNCTION; Schema: public; Owner: valknar
--
...
ALTER FUNCTION public.srid(public.geometry) OWNER TO valknar;
...
--
-- Name: gist_geometry_ops; Type: OPERATOR CLASS; Schema: public; Owner: valknar
--
...
ALTER OPERATOR CLASS public.gist_geometry_ops USING gist OWNER TO valknar;
...
r7bkyiCXrSHhWFBIfPQqgM1XGoP9RgglvfsNNj9eBrlhrVWiHSsLbYd95WFV5XiW	4d310101-f7b1-47fe-982a-efe4abf25c55	2025-09-28 10:57:30.577+00	172.19.0.1	Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36	\N	http://localhost:5173	X_BMMeL5sqBBfLJd1xY0IMEbC9DPcTVoqTJIEtzlQ7w-8hNP2l3_BBtNq-Bph2rJ
ih9VTWH_OQKW_VJuBKrO3R818NBARckoJArgEOMwIzRHCNy10ap0iHqDOIXJceh4	4d310101-f7b1-47fe-982a-efe4abf25c55	2025-09-30 12:31:27.705+00	172.19.0.1	Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36	\N	http://localhost:5173	\N
\.
...
4d310101-f7b1-47fe-982a-efe4abf25c55	Sebastian	Krüger	valknar@pivoine.art	$argon2id$v=19$m=65536,t=3,p=4$vtigbG/p86I0WqpqZviaLA$V6BYW2C9h8t/IMVIS26fIAwO4J1zTCoLM71NoiVduKw	\N	\N	Visionary leader with 15+ years in digital media and content creation.	["Love","Sex","Design","Art"]	e77c58c1-f718-4b7a-b34c-c42861c8122f	\N	\N	active	ea3a9127-2b65-462c-85a8-dbafe9b4fe24	\N	2025-09-28 10:57:20.593+00	/files/3001a83c-3033-4dd1-b3ac-c910bdb1ef2c	default	\N	\N	t	\N	\N	\N	\N	\N	auto	pivoine.art	valknar	2025-09-09 12:00:00	t	Valknar	d3f53a9b-bbce-436c-a6f4-04e5ef120d7e
\.
...
--
-- Data for Name: spatial_ref_sys; Type: TABLE DATA; Schema: public; Owner: valknar
--
...
--
-- Data for Name: topology; Type: TABLE DATA; Schema: topology; Owner: valknar
--
...
--
-- Data for Name: layer; Type: TABLE DATA; Schema: topology; Owner: valknar
--
...
SELECT pg_catalog.setval('public.directus_activity_id_seq', 1004, true);
...
SELECT pg_catalog.setval('public.sexy_videos_directus_users_id_seq', 2, true);


--
-- Name: topology_id_seq; Type: SEQUENCE SET; Schema: topology; Owner: valknar
--
...
\unrestrict 6e7uZ9W0sqETd8UfXp7ddsASlAKcWRlNbmw5rbuDfC1aEQeo3tlsVQsvYmuatDn
